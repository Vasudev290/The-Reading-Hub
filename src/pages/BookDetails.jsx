...
const BookDetails = () => {
  ...
  const isBorrowed = user?.borrowedBooks?.some(b => b.id === book.id && !b.returned);
            ...
            <div className="p-8 md:w-2/3">
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="text-lg text-gray-600 dark:text-gray-300 ml-2">
                  ...
                  {book.reviews?.length > 0 && ` (${book.reviews.length} reviews)`}
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <p className="text-lg text-gray-900 dark:text-white">{book.category}</p>
                </div>
                <div>
                  <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Price</span>
                  <p className="text-lg font-bold text-blue-600 dark:text-blue-400">${book.price}</p>
                </div>
                <div>
